    ...
    <body>
        ...
        <main style=" background-color:#1f4847  !important;">
                    ...
                    <div class="col" style="position: relative; left: 20px;">
                        <a class="text-decoration-none">
                            <div
                                ...
                                <a class="text-decoration-none">
                                    <img src="{{ asset($tempat->image) }}"
                                        style="height: 270px; width: 100%; margin-top: 10px;">
                                </a>
                                <div style="position: relative; margin-left: 20px; text-align: left;">
                                    <h4>Nama:{{ $tempat->nama_tempat }}</h4>
                                    <h4>Kategori:{{ $tempat->category->category }}</h4>
                                    <h4>Deskripsi:{{ $tempat->deskripsi }}</h4>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="row" style="display: flex; justify-content: space-between;">
                <div class="col" style="position: relative; left: 20px;">
                    <a class="text-decoration-none">
                        <h1 style="font-size: 2rem; color: rgb(255, 255, 255); padding-left: 2px;">Pemilik Nama Tempat</h1>
                        <div
                            style="display: flex; align-items: center; height: 200px; width: 320px; background-color: rgb(255, 253, 253); border-radius: 0%; overflow: hidden; padding: 15px;">
                            <img src="/img/user.png" style="height: 110px; width: 40%;">
                            <div style="margin-left: 20px;">
                                <h3 style="color: black;">Nama: {{ $tempat->nama_pemilik }}</h3>
                ...
                @if ($tour_guide)
                    <div class="col" style="position: relative; margin-left: auto; right: -450px;">
                        <a class="text-decoration-none">
                            ...
                            <div
                                style="display: flex; align-items: center; height: 200px; width: 320px; background-color: rgb(255, 253, 253); border-radius: 0%; overflow: hidden; padding: 15px;">
                                <img src="{{asset($tour_guide[0]->image)}}" style="height: 110px; width: 110px; border-radius: 50%; object-fit: cover;">
                                <div style="margin-left: 20px;">
                                    <h3 style="color: black;">Nama: {{ $tour_guide[0]->nama }}</h3>
                                    <img src="/img/chat.png" style="height: 60px; width: 30%; margin-top: 10px;">
                                </div>
                            </div>
                        </a>
