    ...
    <div class="flex flex-wrap items-center justify-between py-4">
            ...
            <nav
                ...
                <ul class="md:flex : items-center">
                    <li class="md:ml-4"><a
                            ...
                            href="/">Home</a></li>
                    <li class="md:ml-4"><a
                            class="text-xl py-2 inline-block text-white font-medium hover:bg-sky-100 lg:hover:bg-transparent lg:border-0 hover:w-full px-2 hover:text-teal-950"
        ...
        <div class="sm:hidden md:block lg:block">
            <ul class="flex justify-end ">
                ...
                <li class="ml-6 none">
                    <a href="https://instagram.com/wonderful_aceh4?igshid=MTIyMzRjYmRlZg==" target="_blank" title="">
